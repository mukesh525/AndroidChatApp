package com.example.mukesh.androidchatapp.communication;
...
{
	private static final String AUTHENTICATION_SERVER_ADDRESS = "http://192.168.1.143/android-im/index.php"; //TODO change to your WebAPI Address
	
	private int listeningPort = 0;
	
	private static final String HTTP_REQUEST_FAILED = "HTTP_REQUEST_FAILED";
